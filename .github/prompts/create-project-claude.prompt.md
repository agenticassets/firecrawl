---
agent: 'agent'
description: "Generate or update comprehensive project root CLAUDE.md as single source of project truth with essential context and rules."
name: "create-project-claude"
---
