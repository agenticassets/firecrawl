---
agent: 'agent'
description: "Review and verify accuracy of documentation files (including README.md, CLAUDE.md, and related Markdown guides across subfolders) against actual codebase implementation, removing outdated information without increasing documentation complexity."
